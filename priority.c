...
// print top bar
    ...
    printf("\n\n");
printf("Process Name\tArrival Time\tBurst Time\tPriority\tCompletion Time\tTurn Around Time\tWaiting Time\n");
printf("------------------------------------------------------------------------------------------\n");
for(i=0;i<n;i++)
{
printf("%s\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d\n",q[i].p_name,q[i].p_at,q[i].p_bt,q[i].p_prio,q[i].p_ct,q[i].p_tat,q[i].p_wt);
}
printf("\n");
for(i=0;i<n;i++)
{
