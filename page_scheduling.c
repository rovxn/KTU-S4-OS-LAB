...
int count = 0, avail, hitr = 0, missr = 0, hitc = 0, missc = 0;
...
printf("%d\t", page[j]);
 ...
 hitr = (size - missc)*100/size;
 missr = missc*100/size;
 printf("\n\nHit ratio = %d\n",hitr);
 printf("\nMiss ratio = %d\n",missr);
 printf("\nPage Fault = %d\n",missc);
}
...
int count = 0, avail, max, maxind, timer = 0, hitr = 0, missr = 0, hitc = 0, missc = 0;
...
int count = 0, avail, max, maxind, timer = 0, temp, hitr = 0, missr = 0, hitc = 0, missc = 0;
